...
class Circle {
    ...
    var r : Double {
        set{
            ...
            print("YYHLog ------ setter", area)
        }
        get{
            print("YYHLog ------ getter", sqrt(area / 3.14158926))
...
class Circle2 {
    ...
    var area: Double = 0.0{
        ...
        willSet{
            ...
            print("YYHLog ------ willSet", newValue)
            print(r);
        }
        
        didSet{
            print("YYHLog ------ didSet", r)
            print(r);
        }
...
let circl = Circle.init()
circl.r = 10
Circle2().area = circl.r;
...
for person in persons {
    ...
    if let p = person as? Teacher {
        print("YY-as? 我是Teacher");
    }
    if let p = person as? Person2 {
        print("YY-as? 我是Person");
    }
